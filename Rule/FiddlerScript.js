...
class Handlers
{
    ...
    */
    ...
    public static var flag01: String = null;
    ...
    static function upm3u8(index: int,data: String) {
    ...
    static function OnBeforeRequest(oSession: Session) {
        ...
        //var gjc=".m3u8";
        var gjc=".m3u8?";
        if(oSession.fullUrl.IndexOf(gjc)!=-1 && oSession.fullUrl!=flag01){
            flag01=oSession.fullUrl
            FiddlerObject.log("getUrl:"+oSession.fullUrl);
            FiddlerObject.log("flag:"+flag01);
            upm3u8(oSession.id,oSession.fullUrl);
            oSession.url="";
        }
        var gjc1="signPlaybackUrl";
        if(oSession.fullUrl.IndexOf(gjc1)!=-1){
            FiddlerObject.log("getUrl1:"+oSession.fullUrl);
            var flag2=oSession.fullUrl.indexOf("url%3D") + 6;
            var urldata=oSession.fullUrl.substring(flag2,oSession.fullUrl.indexOf("&",flag2));
            urldata=decodeURIComponent(urldata)
            upm3u8(oSession.id,urldata);
        }
